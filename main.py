...
# Batteries
            ...
            message = mat[45] + '\n' + using[45] + '\n' + rec[45]
            tts = 'Н`икель-металл-гидридный аккумулятор. Используется в электронных устройствах. Ни в коем случае не выбрасывайте! Обязательно сдайте в пункт приёма на утилизацию'
