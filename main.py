...
# Plastic
        elif '1' in list_of_request or 'пэт' in list_of_request or 'pet' in list_of_request or 'pete' in list_of_request:
            message = mat[0] + '\n'+ "Использование: " + using[0] + '\n' + rec[0]
            tts = message

        elif '2' in list_of_request or 'пэ' in list_of_request or 'пнд' in list_of_request or 'пэвп' in list_of_request or 'hdpe' in list_of_request or 'pehd' in list_of_request:
            message = mat[1] + '\n' + "Использование: " + using[1] + '\n'+ rec[1]
            tts = message

        elif '3' in list_of_request or 'пвх' in list_of_request or 'pvc' in list_of_request:
            message = mat[2] + '\n' + "Использование: " + using[2] + '\n'+ rec[2]
            tts = message

        elif '4' in list_of_request or 'пвд' in list_of_request or 'пэнп' in list_of_request or 'ldpe' in list_of_request or 'peld' in list_of_request:
            message = mat[3] + '\n' + "Использование: " + using[3] + '\n'+ rec[3]
            tts = message

        elif '5' in list_of_request or 'пп' in list_of_request or 'pp' in list_of_request:
            message = mat[4] + '\n' + "Использование: " + using[4] + '\n'+ rec[4]
            tts = message

        elif '6' in list_of_request or 'пс' in list_of_request or 'ps' in list_of_request:
            message = mat[5] + '\n' + "Использование: " + using[5] + '\n'+ rec[5]
            tts = message

        elif '7' in list_of_request or 'о' in list_of_request or 'o' in list_of_request or 'other' in list_of_request or 'другое' in list_of_request:
            message = mat[6] + '\n' + "Использование: " + using[6] + '\n'+ rec[6]
            tts = message

        elif 'abs' in list_of_request:
            message = mat[7] + '\n' + "Использование: " + using[7] + '\n'+ rec[7]
            tts = message

        elif 'pc' in list_of_request:
            message = mat[8] + '\n' + "Использование: " + using[8] + '\n'+ rec[8]
            tts = message
    
# Paper
        elif '20' in list_of_request:
            message = mat[9] + '\n' + "Использование: " + using[9] + '\n'+ rec[9]
            tts = message

        elif '21' in list_of_request:
            message = mat[10] + '\n' + "Использование: " + using[10] + '\n'+ rec[10]
            tts = message

        elif '22' in list_of_request:
            message = mat[11] + '\n' + "Использование: " + using[11] + '\n'+ rec[11]
            tts = message

        elif '23' in list_of_request:
            message = mat[12] + '\n' + "Использование: " + using[12] + '\n'+ rec[12]
            tts = message
        
        elif 'pap' in list_of_request:
...
# Metals
        elif '40' in list_of_request or 'fu' in list_of_request:
            message = mat[13] + '\n' + "Использование: " + using[13] + '\n'+ rec[13]
            tts = message

        elif '41' in list_of_request or 'alu' in list_of_request:
            message = mat[14] + '\n' + "Использование: " + using[14] + '\n'+ rec[14]
            tts = message
        
# Organic materials of natural origin
        elif '50' in list_of_request or 'for' in list_of_request or 'фор' in list_of_request:
            message = mat[15] + '\n' + "Использование: " + using[15] + '\n'+ rec[15]
            tts = message

        elif '51' in list_of_request:
            message = mat[16] + '\n' + "Использование: " + using[16] + '\n'+ rec[16]
            tts = message
        
        elif '60' in list_of_request or 'tex' in list_of_request or 'текс' in list_of_request:
            message = mat[17] + '\n' + "Использование: " + using[17] + '\n'+ rec[17]
            tts = message

        elif '61' in list_of_request:
            message = mat[18] + '\n' + "Использование: " + using[18] + '\n'+ rec[18]
            tts = message

# Glass
        elif '70' in list_of_request:
            message = mat[19] + '\n' + "Использование: " + using[19] + '\n'+ rec[19]
            tts = message
        
        elif '71' in list_of_request:
            message = mat[20] + '\n' + "Использование: " + using[20] + '\n'+ rec[20]
            tts = message

        elif '72' in list_of_request:
            message = mat[21] + '\n' + "Использование: " + using[21] + '\n'+ rec[21]
            tts = message
        
        elif '73' in list_of_request:
            message = mat[22] + '\n' + "Использование: " + using[22] + '\n'+ rec[22]
            tts = message

        elif '74' in list_of_request:
            message = mat[23] + '\n' + "Использование: " + using[23] + '\n'+ rec[23]
            tts = message
        
        elif '75' in list_of_request:
            message = mat[24] + '\n' + "Использование: " + using[24] + '\n'+ rec[24]
            tts = message

        elif '76' in list_of_request:
            message = mat[25] + '\n' + "Использование: " + using[25] + '\n'+ rec[25]
            tts = message

        elif '77' in list_of_request:
            message = mat[26] + '\n' + "Использование: " + using[26] + '\n'+ rec[26]
            tts = message
        
        elif '78' in list_of_request:
            message = mat[27] + '\n' + "Использование: " + using[27] + '\n'+ rec[27]
            tts = message

        elif '79' in list_of_request:
            message = mat[28] + '\n' + "Использование: " + using[28] + '\n'+ rec[28]
            tts = message
        
# Composite materials
        elif '81' in list_of_request:
            message = mat[29] + '\n' + "Использование: " + using[29] + '\n'+ rec[29]
            tts = message

        elif '82' in list_of_request:
            message = mat[30] + '\n' + "Использование: " + using[30] + '\n'+ rec[30]
            tts = message
        
        elif '84' in list_of_request:
            message = mat[31] + '\n' + "Использование: " + using[31] + '\n'+ rec[31]
            tts = message

        elif '90' in list_of_request:
            message = mat[32] + '\n' + "Использование: " + using[32] + '\n'+ rec[32]
            tts = message
        
        elif '92' in list_of_request:
            message = mat[33] + '\n' + "Использование: " + using[33] + '\n'+ rec[33]
            tts = message

        elif '98' in list_of_request:
            message = mat[34] + '\n' + "Использование: " + using[34] + '\n'+ rec[34]
            tts = message
            
        elif 'c/pap' in list_of_request or 'c/pp' in list_of_request or 'c/ldpe' in list_of_request or 'c/alu' in list_of_request:
