...
# Organic materials of natural origin
            ...
            tts = "'Хлопок. Примеры использования: тканевые принадлежности, нити, вата. Одежду можно сдать на переработку или продать"
...
# Plastic
            ...
            tts = "Полиэтилен низкого давления. Примеры использования: упаковки от шампуня, геля для 'душа, моющих средств. Такие упаковки обычно имеют большой шов на дне. Успешно перерабатывается!"
